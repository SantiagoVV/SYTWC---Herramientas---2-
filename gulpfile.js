// generated on 2022-10-20 using generator-webapp 4.0.0-8
...
gulp.task("default", function() { 
  ...
  gulp.src('./app/styles/*.*').pipe(concatCss("super.css")).pipe(gulp.dest('dist'));
  gulp.src("./app/scripts/*.*").pipe(gulp.dest("dist"));
});
